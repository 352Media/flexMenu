...
(function($) {
	...
	$.fn.flexMenu = function( options ) {
		...
		return this.each(function() {
			...
			var firstItemTop = Math.floor($firstItem.offset().top);
			var firstItemHeight = Math.floor($firstItem.height());
			...
			// Values be calculated from em and give us something other than round numbers. Browsers may round these inconsistently. So, let's round numbers to make it easier to trigger flexMenu.
				...
				for (i = numItems; i = 1; i-- ) {
					...
					var keepLooking = (needsMenu($lastChild));
